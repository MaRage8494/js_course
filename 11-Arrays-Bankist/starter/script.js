...
// // SLICE - возвращает кусок массива
// console.log(arr.slice(2));
// console.log(arr.slice(2, 4));
// console.log(arr.slice(-2));
// console.log(arr.slice(1, -2));

// // SPLICE - вырезает часть с исходного массива
...
// // JOIN - объединяет элементы, вставляя разделитель
...
//   //? Первый аргумент это элемент массива, второй - его индекс, третий - сам массив
//   if (movement > 0) {
...
btnLogin.addEventListener('click', function (e) {
  e.preventDefault(); //? Нужно для того, чтобы форма заранее не отправлялась
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    inputLoginPin.blur(); //? Убирает курсор с поля входа
